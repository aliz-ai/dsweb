...
@WithTokenizers( { PersonListPlace.Tokenizer.class, PersonDetailPlace.Tokenizer.class, ShowcasePlace.Tokenizer.class, SandboxPlace.Tokenizer.class, ChartPlace.Tokenizer.class } )
